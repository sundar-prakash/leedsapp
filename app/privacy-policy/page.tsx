    ...
    <>
      ...
      <div className="max-w-3xl mx-auto p-6 text-gray-800">
        ...
        <section className="prose lg:prose-xl mx-auto">
          <p>
            City Page built the LeedsApp app as a Commercial app. This service is
            provided by City Page and is intended for use as is.
          </p>
          ...
          <h2 className="text-2xl font-semibold mt-4">Information Collection and Use</h2>
          <p>
            For a better experience, while using our Service, we may require you to
            provide us with certain personally identifiable information, including but
            not limited to contacts, location, storage, camera, microphone, notifications,
            phone, sms, photos. The information that we request will be retained by us
          ...
          <p>
            We want to inform you that whenever you use our Service, in case of an error
          ...
          <h2 className="text-2xl font-semibold mt-4">Service Providers</h2>
          <p>
          ...
          <p>
            ...
            tasks assigned to them on our behalf and are obligated not to disclose or use
          ...
          <h2 className="text-2xl font-semibold mt-4">Links to Other Sites</h2>
          <p>
            This Service may contain links to other sites. If you click on a third-party
            link, you will be directed to that site. Note that these external sites are
            not operated by us. Therefore, we h4ly advise you to review the Privacy Policy
          ...
          <p>This policy is effective as of 2023-03-11</p>

          <h2 className="text-2xl font-semibold mt-4">Contact Us</h2>
          <p>
            If you have any questions or suggestions about our Privacy Policy, do not hesitate
            to contact us at <a href="mailto:support@leadsapp.com" className="text-blue-600">support@leadsapp.com</a>.
          </p>
        </section>
      </div>
    </>
